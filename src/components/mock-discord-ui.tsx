      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-y-px">
              {["Jackie Moons", "Bishii", "Cmoney", "MiKE"].map((name) => (
                <div
                  key={name}
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex items-center space-x-2">
            <Mic className="size-5 text-[#b9bbb3] hover:text-white" />
            <Headphones className="size-5 text-[#b9bbb3] hover:text-white" />
            <Cog className="size-5 text-[#b9bbb3] hover:text-white" />
          </div>
        </div>
      </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              ...
              className="flex-1 bg-transparent py-1.5 px-1 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed"
            />
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="siz-5 hover:text-white cursor-not-allowed hidden sm:block" />
              <Sticker className="siz-5 hover:text-white cursor-not-allowed hidden sm:block" />
              <Smile className="siz-5 hover:text-white cursor-not-allowed hidden sm:block" />
            </div>
          </div>
        </div>
      </div>
